...
const MyDonations = () => {
   ...
   const columns = [
      columnHelper.accessor("petImg", {
         id: "petImg",
         header: () => <span className="mr-3 text-orange-400 sm:mr-0">Pet Image</span>,
         cell: (info) => {
            return (
      ...
      columnHelper.accessor("petName", {
         id: "petName",
         header: () => <span className="mr-3 text-orange-400 sm:mr-0">Pet Name</span>,
         cell: (info) => <span className="text-[#ffffff]">{info.getValue()}</span>
      }),
      columnHelper.accessor("donationAmount", {
         id: "donationAmount",
         header: () => <span className="mr-3 text-orange-400 sm:mr-0">Amount</span>,
         cell: (info) => <span className="text-[#ffffff] ">{info.getValue()}</span>
      }),
      columnHelper.display({
         id: "refund",
         header: () => <span className="mr-3 text-orange-400 sm:mr-0">Refund</span>,
         cell: (info) => {
            return (
   ...
   return (
      <div className="w-full overflow-x-auto ">
         ...
         <div className="flex flex-col items-center">
            ...
            <p className="sm:flex justify-center text-[#ffffff] tracking-wide text-sm">You have donated <span className="text-sm font-semibold text-orange-300 sm:mx-2 sm:text-xl">{donatorData.length} </span> campaigns.Thank you for your kindness!</p>
         </div>
